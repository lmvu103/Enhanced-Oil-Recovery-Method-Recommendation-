...
with st.sidebar.header(":file_folder: 1. Upload the csv data"):
    ...
    st.sidebar.markdown(
        """
    [Download csv file](https://raw.githubusercontent.com/lmvu103/Enhanced-Oil-Recovery-Method-Recommendation-/refs/heads/main/DATA%20WORLWIDE%20EOR%20PROJECTSP.csv
)
    """
    )
